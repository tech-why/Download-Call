 ...
 *
 */
public class MapSearchService  extends BaseExtendService  implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setTitle("校园导航");
		article.setDescription("");
		article.setPicUrl(bundler.getString("domain")+ "/plug-in/weixin/images/xinshengyindao.jpg");
		
		article.setUrl(bundler.getString("domain")+ "/schoolController.do?display&app_code=helper&open_user_id="+ defaultMessage.getToUserName());
