 ...
 *
 */
public class MyProblemRecordService  extends BaseExtendService  implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setTitle("我的维修单");
		article.setDescription("");
		article.setPicUrl(bundler.getString("domain")+ "/plug-in/weixin/images/xinshengyindao.jpg");
		
		article.setUrl(bundler.getString("domain")+ "/submitProblemController.do?list&open_user_id="+ defaultMessage.getToUserName());
