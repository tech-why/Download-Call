 ...
 *
 */
public class SubmitProblemService  extends BaseExtendService  implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setTitle("故障报修");
		article.setDescription("");
		article.setPicUrl(bundler.getString("domain")+ "/plug-in/weixin/images/xiaoyuanchaoshi.jpg");
		
		article.setUrl(bundler.getString("domain")+ "/submitProblemController.do?display&app_code=problem&open_user_id="+ defaultMessage.getToUserName());
