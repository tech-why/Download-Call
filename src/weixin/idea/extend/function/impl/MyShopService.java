 ...
 *
 */
public class MyShopService  extends BaseExtendService  implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setTitle("校园超市");
		article.setDescription("");
		article.setPicUrl(bundler.getString("domain")+ "/plug-in/weixin/images/xiaoyuanchaoshi.jpg");
		
		article.setUrl(bundler.getString("domain")+ "/schoolController.do?display&app_code=shop&open_user_id="+ defaultMessage.getToUserName());
