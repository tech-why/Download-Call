 ...
 *
 */
public class CmsService  extends BaseExtendService implements KeyServiceI {
	...
	public String excute(String content, TextMessageResp defaultMessage,
		...
		article.setTitle("电信营业厅");
		article.setDescription("");
		article.setPicUrl(bundler.getString("domain")+ "/plug-in/weixin/images/tianyi.jpg");
