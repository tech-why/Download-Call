...
<div class="container-fluid"><a class="brand" href="#" target="_blank">王童鞋校园服务平台&nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="#" title="王童鞋校园服务平台">王童鞋校园服务平台</a></li>
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度) 技术支持:<a title="王童鞋团队 " href="#">王童鞋团队 </a></li>
</ul>
</div>
</footer>
