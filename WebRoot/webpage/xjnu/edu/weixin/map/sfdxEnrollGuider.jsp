...
var init = function() {
    ...
    var text1 = '音乐厅';
    var point1 = new qq.maps.LatLng(43.833025,87.592632);
    var text2 = '大门入口';
    var point2 = new qq.maps.LatLng(43.834867,87.593865);
    var text3 = '国交楼';
    var point3 = new qq.maps.LatLng(43.831928,87.592462);
    var text4 = '文史楼';
    var point4 = new qq.maps.LatLng(43.832935,87.591373);
   buildBounds(point1);
    buildBounds(point2);
    buildBounds(point3);
    buildBounds(point4);
