...
var init = function() {
    ...
    var center = new qq.maps.LatLng(43.8144,87.564735);
    var point1 = new qq.maps.LatLng(43.8144,87.564735);
    var text1 = '篮球场';
    var point2 = new qq.maps.LatLng(43.813347,87.57061);
    var text2 = '大门入口';
    var point3 = new qq.maps.LatLng(43.810944,87.565445);
    var text3 = '校医院';
    var point4 = new qq.maps.LatLng(43.814465,87.56755);
    var text4 = '大礼堂';
    var point5 = new qq.maps.LatLng(43.817253,87.569700);
    var text5 = '侧门入口';
    ...
    showSingleTextMarker(map , point1 , text1);
     showSingleTextMarker(map , point2 , text2);
      showSingleTextMarker(map , point3, text3);
       ...
       showSingleTextMarker(map , point5, text5);
      <c:if test="${flag == 'true'}">
			...
			<div class="panel product-info">
				<div class="panel-body" style="padding:10px;">
					...
					<div class="detail-info">
						为分散集中报到时部分流程的排队现象，建议大家适当打乱流程：<br>
						路线1（管理学院、机械交通学院、外国语学院、水利与土木工程学院）
						大礼堂--校医院--寝室--篮球场<br>
						<br>
						路线2（经济与贸易学院、动物科学学院、动物医学学院、林学与园艺学院）
						校医院--大礼堂--寝室--篮球场<br>
						<br>
						路线3（食品科学与药学学院、数理学院、中国语言学院、国际教育学院、农学院）
						寝室--校医院--篮球场--大礼堂<br>
						<br>
						路线4（化学工程学院、计算机与信息工程学院、继续教育学院、草业与环境科学学院）
						寝室--大礼堂--校医院--篮球场<br>
