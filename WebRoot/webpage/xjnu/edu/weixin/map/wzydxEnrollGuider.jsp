...
var init = function() {
    var center = new qq.maps.LatLng(43.783757,87.650913);
    var text1 = '大门入口';
    var point1 = new qq.maps.LatLng(43.783757,87.650913 );
    var text2 = '侧门入口';
    var point2 = new qq.maps.LatLng(43.783795,87.652892);
    buildBounds(point1);
    buildBounds(point2);
		...
		<div id="productDetail">
			...
			<div class="panel product-info">
				<div class="panel-body" style="padding:10px;">
					...
					1.欢迎来到乌鲁木齐职业技术大学，首先进入正门。<br>
					2.然后来到迎新现场办理保险、购置服装等。（所有学院的迎新队伍都在一起）<br>
