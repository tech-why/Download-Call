...
var init = function() {
    var center = new qq.maps.LatLng(43.902363,87.539799);
    var text1 = '大门入口';
    var point1 = new qq.maps.LatLng(43.902363,87.539799);
    var text2 = '迎新点';
    var point2 = new qq.maps.LatLng(43.902475,87.538464);
    buildBounds(point1);
    buildBounds(point2);
