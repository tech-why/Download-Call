...
var init = function() {
    var center = new qq.maps.LatLng(43.784020,87.652893);
    var text1 = '大门入口';
    var point1 = new qq.maps.LatLng(43.784020,87.652893);
    var text2 = '行政楼';
    var point2 = new qq.maps.LatLng(43.784876,87.652829);
    buildBounds(point1);
    buildBounds(point2);
		...
		<div id="productDetail">
			...
			<div class="panel product-info">
				<div class="panel-body" style="padding:10px;">
					...
					1.欢迎来到新疆师范大学青年政治学院，首先进入正门。<br>
					2.然后来到迎新现场办理保险、购置服装等。<br>
