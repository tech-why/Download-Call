...
<BODY>
	<DIV id="index" data-role="page" data-wlm-listpage="zhiwei-list"
		...
		<DIV data-role="header">
			...
			<DIV class="nav">
				<DIV class="navBar">
					<%-- <a data-ajax='false' href='${webRoot}/partTimeJobController.do?partTimeJob' class='navQiuzhi current'>招聘</a> --%>
					<%-- <a data-ajax='false' href='${webRoot}/partTimeJobController.do?partTimeJob'>招聘</a> --%>
					<!-- <a data-ajax='false' href='http://m.wealink.com/renmai/' class='navShejiao'>人脉</a>
					<a data-ajax='false' href='http://m.wealink.com/dianping/' class='navZixun'>发现</a>
					<a data-ajax='false' href='http://m.wealink.com/wode/' class='navWode'>我的</a> -->
				</div>
                   <div class="barBoth bar1" ><a data-ajax='false' href='${webRoot}/partTimeJobController.do?partTimeJob' class='zhiweiZhao colgrey addUnderline'>找兼职</a>
                   <a data-ajax='false' href='${webRoot}/jobController.do?job' class='boleZhao current'>找工作</a></div>
            </div>
       </div>
		<DIV class="Qiuzhi" data-role="content">
			<DIV class="searchBar">
				<P>
					<A href="${webRoot}/selectInfoController.do?selectJob" data-ajax="false">  <SPAN
			...
			<DIV class="content zhiwei">
				...
				<UL class="kind1"
				 ...
				 data-wlm-url="${webRoot}/jobController.do?jobitem"
				 data-wlm-offset="10"
				 data-icon="false">

					<c:forEach items="${tbJobList}" var="tbj">
						<LI class="line"></LI>
						<LI class="item"><A
							href="${webRoot}/jobDetailController.do?jobDetail&jobId=${tbj.id}"
							data-transition="slide"> <IMG width="74" height="55"
								class="pic" src="${tbj.imagesUrl }"> 
								<UL>
									<LI>
										<H3>
											${tbj.positionname }<SPAN >${tbj.salary }</SPAN>
										</H3></LI>
									<LI>
										<H4>
									...
									<LI>
										<H4>
											${tbj.workPlace}<SPAN class="data">${tbj.creatTime }</SPAN>
										</H4></LI>
								</UL> </A></LI>
					</c:forEach>
