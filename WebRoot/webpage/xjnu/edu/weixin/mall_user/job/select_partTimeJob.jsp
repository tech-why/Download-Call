		...
		<div data-role="content" class="ui-content" role="main">
			<div class="searchContent">
				<form id="formSearch" method="post"
					action="${webRoot}/partTimeJobController.do?selectPartTimeJob" data-ajax="false">
					...
					<ul class="choose f24">
						 <li class="colb" data-wlm-filter-field="tbAreaCatalogEntity_id" data-filter-parent-field = "tbAreaCatalogEntity_tbAreaClassEntity_id">选择区域
						 <input type="hidden" name="tbAreaCatalogEntity.id" id = "tbAreaCatalogEntity_id" value="">
						 <input type="hidden" name="tbAreaCatalogEntity.tbAreaClassEntity.id" id = "tbAreaCatalogEntity_tbAreaClassEntity_id" value="">
						 <a href="javascript:void(0);" id="label-tbAreaCatalogEntity_id" class="ui-link">不限</a>
						 </li>
						 <li class="colb" data-wlm-filter-field="tbJobCatalogEntity_id" data-filter-parent-field = "tbJobCatalogEntity_tbJobClassEntity_id" >选择兼职
						<input type="hidden" name="tbJobCatalogEntity.id" id = "tbJobCatalogEntity_id" value="">
						<input type="hidden" name="tbJobCatalogEntity.tbJobClassEntity.id" id = "tbJobCatalogEntity_tbJobClassEntity_id" value="">
						<a href="javascript:void(0);" id="label-tbJobCatalogEntity_id" class="ui-link">不限</a>
						</li>
