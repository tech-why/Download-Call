		...
		function searchKey(key)
		{
			...
			$.each(classlist,function(i) {
				...
				if( flag || keytext.test(title)){
					...
					html += '	<a href="telCatalogController.do?select&schoolId='+classlist[i]['id']+'&open_user_id=${openuserid}" class="panel-title">'+classlist[i]['schoolName']+'<i class="fa fa-angle-right"></i></a>';
					html += '</li>';
				}
			})
			$('#clublist').html(html);
